...
(function () {
  ...
  var ICON_NAMES = ['typewriter','magnifier','book','speech-bubble','tree','joystick','paintbrush','trash','terminal','help','gear','folder','brain','browser','palette','music','video','notepad','calculator','camera','calendar','mail','clock','document','star','fullscreen'];
  ...
  function makePreviewIcon(iconName) {
    var colors = {typewriter:'#7DFFC2',magnifier:'#FFE66D',book:'#FF6B9D','speech-bubble':'#7DFFC2',tree:'#7DFFC2',joystick:'#D4D0C8',paintbrush:'#FFE66D',trash:'#D4D0C8',terminal:'#1A1A1A',help:'#FFE66D',gear:'#D4D0C8',folder:'#FFE66D',brain:'#FF6B9D',fullscreen:'#7DFFC2',calculator:'#D4D0C8',mail:'#FAFAF5'};
